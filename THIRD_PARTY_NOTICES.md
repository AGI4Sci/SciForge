...
| OpenHands Software Agent SDK | Stateless event-driven agent-step, conversation-runner, and bounded stuck-detection architecture. | Reference/inspiration only. SciForge's TypeScript runner and detector are independently implemented over SciForge `TurnItem` records; no OpenHands source code, tests, fixtures, binaries, or assets are copied. |
| mini-SWE-agent | Minimal linear model/action/observation trajectory and explicit step/tool-budget design constraints. | Reference/inspiration only. SciForge does not adopt mini-SWE-agent's Python or bash-only runtime, and no source code, tests, fixtures, binaries, or assets are copied. |
...
| OpenHands Software Agent SDK | `https://github.com/OpenHands/software-agent-sdk` | `75842b1f9fba38af4e9f384177d7b5c7e5b23013` | MIT (`LICENSE`) | MIT, checked 2026-07-10 | Agent-loop architecture reference only. SciForge's TypeScript implementation is independent; no OpenHands source, tests, fixtures, binaries, or assets are copied. |
| mini-SWE-agent | `https://github.com/SWE-agent/mini-swe-agent` | `e187bcb2ff5825d85761a6f9c1f98c9fa6cfbc79` | MIT (`LICENSE`) | MIT, checked 2026-07-10 | Minimal-loop and budget reference only. No mini-SWE-agent source, tests, fixtures, binaries, or assets are copied. |
