...
The authority carried by an exact caller/Principal/Workspace-bound Broker resource after its root or parent has been authorized. A declared write still requires separate invocation admission; the resource cannot change Provider, escape to a sibling or ancestor, synthesize a resource identity, or broaden a destructive target.
