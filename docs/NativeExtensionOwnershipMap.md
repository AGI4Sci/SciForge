...
| `packages/observe/vision` | L0 sense/grounding provider | observation、focus region、OCR、`qwen3.7-plus` VLM/grounding helper、verifier feedback、file-ref-only visual memory。 | 真实桌面输入、scheduler lease、executor adapter、desktop bridge 或 completion 判断。 |
