...
rendered the Coordinator Worker User online/readiness list. The U0 source process was
...
retained Project focus and the User-only Worker online/readiness list remain
required; 7.4 is still `approval_required`, not passed.
