...
| [`TuiGuiProtocol.md`](TuiGuiProtocol.md) | **当前协议真相源** | GUI → TUI 文本输入，TUI 读取 GUI resource tree，TUI → GUI intent-based `gui.*` tools，annotation feedback envelopes、展示组件目录、对象引用、confidence、hot region、precondition 和协商。 |
