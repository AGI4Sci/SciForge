...
& Multi-backend support (Codex, Claude Code, custom runtimes); sub-agent delegation; MCP worker invocation; long-task recovery $\uparrow$ \\
Workflow Engine
