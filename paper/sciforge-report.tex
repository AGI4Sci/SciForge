...
\begin{itemize}
  ...
  \item \textbf{AI4AI: Protein and Structure Modeling} (Section~4.2): \url{https://github.com/AGI4Sci/sciforge-ai4ai} --- Automated protein function prediction and structure analysis using Esm2Text, Prot2Text, and AlphaFold3 integration.
  \item \textbf{Reviewer / Rebuttal Mode} (Section~4.3): \url{https://github.com/AGI4Sci/sciforge-review} --- Evidence-governed peer review and response workflow.
  ...
  \item \textbf{Cross-Scale Cell Atlas} (Section~4.5): \url{https://github.com/AGI4Sci/sciforge-cell-atlas} --- Multi-database integration and guided-level analysis for cross-scale cell atlas construction.
  \item \textbf{AI-Guided Protein Design} (Section~4.6): \url{https://github.com/AGI4Sci/sciforge-protein-design} --- De novo protein design pipeline with ESM~2 embeddings, ProteinMPNN sequence generation, and AlphaFold3 structural validation.
