...
export const manifest: UIComponentManifest = {
  ...
  docs: { readmePath: 'packages/ui-components/structure-viewer/README.md', agentSummary: 'Use for declared structure refs and metadata. Historical molecule-viewer aliases route here.' },
  workbenchDemo: { artifactType: 'structure-summary', artifactData: { pdbId: '1CRN', ligand: 'none', dataRef: 'packages/ui-components/structure-viewer/workbench-demo/1crn.cif', highlightResidues: ['A:22'] } },
};
