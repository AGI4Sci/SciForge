...
export const manifest: UIComponentManifest = {
  ...
  docs: { readmePath: 'packages/ui-components/point-set-viewer/README.md', agentSummary: 'Use for point-set presets. Historical volcano-plot and umap-viewer aliases route here.' },
