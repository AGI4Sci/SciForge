    ...
    steps: [
      ...
      },
      {
        ...
        selfPromptRecommendation: {
          ...
          humanConfirmationPoint: 'A researcher must review the cited refs and approve the prompt before submission.',
          reviewChecklist: ['required refs resolve', 'stop condition is testable', 'verdict language is conservative'],
          mode: 'shadow-only',
        },
      },
    ],
