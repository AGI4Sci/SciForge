...
export const CORE_CAPABILITY_MANIFESTS: CapabilityManifest[] = [
  ...
  toolPrimitiveCapabilityManifest({
    id: 'pdf_extract',
    name: 'PDF extract',
    brief: 'Extract bounded text and page metadata from PDF URLs or refs for downstream LLM processing.',
    sourceRef: 'packages/workers/web-worker/src/web-tools.ts',
    providerId: 'sciforge.web-worker.pdf_extract',
    providerLabel: 'SciForge web worker PDF extract',
