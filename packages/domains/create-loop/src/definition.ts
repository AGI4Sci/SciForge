...
export const WORKFLOW_AUTOMATION_DOMAIN_MODULE_ID =
  domainPackageDefinition.module.id
export const WORKFLOW_AUTOMATION_DOMAIN_PACKAGE_NAME =
  domainPackageDefinition.packageName

export const WORKFLOW_AUTOMATION_CAPABILITY_FACTORY_CONTRIBUTION =
  contributionFor('main', 'main.capability-factory')
export const WORKFLOW_AUTOMATION_RUNTIME_LIFECYCLE_CONTRIBUTION =
  contributionFor('main', 'main.runtime-lifecycle')
export const WORKFLOW_AUTOMATION_RENDERER_COMMAND_CONTRIBUTION =
  contributionFor('renderer', 'renderer.command')
export const WORKFLOW_AUTOMATION_RENDERER_RIGHT_PANEL_CONTRIBUTION =
  contributionFor('renderer', 'renderer.workbench-right-panel')
export const WORKFLOW_AUTOMATION_RENDERER_RIGHT_PANEL_CONTRACT =
  domainPackageDefinition.contributionContracts[
    WORKFLOW_AUTOMATION_RENDERER_RIGHT_PANEL_CONTRIBUTION.id
  ]!
export const WORKFLOW_AUTOMATION_RENDERER_TOOLBAR_ACTION_CONTRIBUTION =
  contributionFor('renderer', 'renderer.workbench-toolbar-action')
export const WORKFLOW_AUTOMATION_RENDERER_TOOLBAR_ACTION_CONTRACT =
  domainPackageDefinition.contributionContracts[
    WORKFLOW_AUTOMATION_RENDERER_TOOLBAR_ACTION_CONTRIBUTION.id
  ]!
export const WORKFLOW_AUTOMATION_RENDERER_I18N_CONTRIBUTION =
...
function contributionFor(process: 'main' | 'renderer', kind: string) {
  ...
  if (!contribution) {
    throw new Error(`Create Loop manifest is missing ${process}:${kind}.`)
  }
  return contribution
}
