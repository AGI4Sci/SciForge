...
import { describeNodeOutput, extractNodeRefs, varTypeToInputType } from '../../workflow-output-descriptors.js'
...
function buildWorkflowRunCurl(settings: CreateLoopRendererSettings, name: string): string {
...
export function NodeConfigPanel({
  ...
  }, [runtime, node?.type, codeValue, codeLanguage])
