...
import type { WorkspacePreviewReadRangeResult } from './transport'
import {
...
export const MOLECULAR_SET_SELECTION_OPERATION_TYPE =
  workspacePreviewExtensionIdSchema.parse('sciforge.life-science-preview.molecular.set-selection')
...
export function createMolecularSelectionOperation(
  ...
  return {
    ...
    operationType: MOLECULAR_SET_SELECTION_OPERATION_TYPE,
    data: { selection }
  }
}
