...
class ThreadGraph:
    ...
    # --- graph views --------------------------------------------------------
    def _digraph(self, rels: Optional[set[EdgeRel]] = None) -> DirectedGraph:
        g = DirectedGraph()
    ...
    def supports_digraph(self) -> DirectedGraph:
    ...
    @staticmethod
    def _cyclic_components(g: DirectedGraph) -> list[list[str]]:
        ...
        """
        return [
            sorted(component) for component in strongly_connected_components(g)
    ...
    def layers(self) -> list[list[str]]:
        ...
        return [sorted(layer) for layer in topological_generations(g)]
