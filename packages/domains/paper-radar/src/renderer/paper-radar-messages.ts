...
export const paperRadarMessages = {
  en: {
    ...
    paperRadarReviewBusy: 'Syncing and ranking papers…',
    paperRadarLocalWhileSyncing: 'Showing recommendations from {{total}} local papers while the latest data syncs.',
    paperRadarLocalFallback: 'Latest sync failed. Showing recommendations from {{total}} locally stored papers.',
  ...
  zh: {
    ...
    paperRadarReviewBusy: '正在同步并生成推荐…',
    paperRadarLocalWhileSyncing: '已先从本地 {{total}} 篇论文生成推荐，正在同步最新数据。',
    paperRadarLocalFallback: '最新数据同步失败，已使用本地 {{total}} 篇论文生成推荐。',
