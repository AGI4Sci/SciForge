...
export const BIOLOGY_ROOM_CAPABILITY_IDS = Object.freeze({
  list: 'biology-room.list',
  create: 'biology-room.create',
  openOrCreate: 'biology-room.open-or-create',
  load: 'biology-room.load',
  open: 'biology-room.open',
  apply: 'biology-room.apply',
  refresh: 'biology-room.refresh',
  history: 'biology-room.history'
} as const)
