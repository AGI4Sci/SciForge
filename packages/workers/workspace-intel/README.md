...
It exposes guarded workspace listing, tree, file read, preview, reference, skill discovery, visible-context lookup, and on-demand visual capture through a pure Node service and an MCP stdio server.
