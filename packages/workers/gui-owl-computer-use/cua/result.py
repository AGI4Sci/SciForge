...
ERROR_CODES = {
    ...
    "ISOLATION_UNAVAILABLE", "ISOLATED_DESKTOP_UNAVAILABLE",
    "SESSION_ID_CONFLICT", "SESSION_NOT_FOUND",
...
_RETRYABLE_CODES = {
    ...
    "HOST_INPUT_BUSY", "CANCEL_PENDING", "CANCEL_DELIVERY_FAILED",
...
_FAILURE_CLASS = {
    ...
    "ISOLATED_DESKTOP_UNAVAILABLE": "routing",
    "ACTION_OUTCOME_UNKNOWN": "outcome-unknown", "CLEANUP_INCOMPLETE": "cleanup",
    "CANCEL_DELIVERY_FAILED": "cleanup",
