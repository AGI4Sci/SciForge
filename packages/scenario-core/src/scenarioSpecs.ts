...
export const SCENARIO_SPECS = {
  'literature-evidence-review': {
    ...
    componentPolicy: {
      ...
      allowedComponents: ['paper-card-list', 'evidence-matrix', 'notebook-timeline', 'data-table', 'unknown-artifact-inspector', 'execution-unit-table'],
      fallbackComponent: 'unknown-artifact-inspector',
      dynamicPlugins: 'disabled-by-default',
    },
    runtimeId: 'bioagent-literature-evidence-review',
  ...
  'structure-exploration': {
    ...
    scenarioMarkdown: [
        ...
        '',
        '默认展示：molecule-viewer、evidence-matrix、execution-unit-table。',
        '',
        '边界：不做分子动力学、不做结合自由能计算、不把结构观察直接升级为机制结论。',
    ].join('\n'),
    componentPolicy: {
      defaultComponents: ['molecule-viewer', 'evidence-matrix', 'execution-unit-table'],
      allowedComponents: ['molecule-viewer', 'evidence-matrix', 'execution-unit-table', 'data-table', 'unknown-artifact-inspector'],
      fallbackComponent: 'unknown-artifact-inspector',
      dynamicPlugins: 'disabled-by-default',
    },
    runtimeId: 'bioagent-structure-exploration',
    mode: 'scenario-server',
  ...
  'omics-differential-exploration': {
    ...
    scenarioMarkdown: [
        ...
        '',
        '默认展示：volcano-plot、heatmap-viewer、umap-viewer。',
        '',
        '边界：不无界处理原始 FASTQ；没有明确设计矩阵时不声称 publication-grade batch correction。',
    ].join('\n'),
    componentPolicy: {
      defaultComponents: ['volcano-plot', 'heatmap-viewer', 'umap-viewer'],
      allowedComponents: ['volcano-plot', 'heatmap-viewer', 'umap-viewer', 'data-table', 'evidence-matrix', 'execution-unit-table', 'unknown-artifact-inspector'],
      fallbackComponent: 'unknown-artifact-inspector',
      dynamicPlugins: 'disabled-by-default',
    },
    runtimeId: 'bioagent-omics-differential-exploration',
    mode: 'scenario-server',
  ...
  'biomedical-knowledge-graph': {
    ...
    scenarioMarkdown: [
        ...
        '',
        '默认展示：network-graph、data-table、evidence-matrix。',
        '',
        '边界：缺少连接器时返回 unsupported/failed-with-reason，不把数据库事实伪装成因果证明。',
    ].join('\n'),
    componentPolicy: {
      defaultComponents: ['network-graph', 'data-table', 'evidence-matrix'],
      allowedComponents: ['network-graph', 'data-table', 'evidence-matrix', 'paper-card-list', 'execution-unit-table', 'unknown-artifact-inspector'],
      fallbackComponent: 'unknown-artifact-inspector',
      dynamicPlugins: 'disabled-by-default',
    },
    runtimeId: 'bioagent-biomedical-knowledge-graph',
    mode: 'scenario-server',
