...
export const SCENARIO_SPECS = {
  ...
  'structure-exploration': {
    ...
    componentPolicy: {
      ...
      allowedComponents: ['molecule-viewer', 'structure-viewer', 'evidence-matrix', 'execution-unit-table', 'data-table', 'record-table', 'unknown-artifact-inspector'],
      fallbackComponent: 'unknown-artifact-inspector',
      dynamicPlugins: 'disabled-by-default',
    },
    ...
    defaultSlots: [
      { componentId: 'molecule-viewer', title: '结构查看器', artifactRef: 'structure-summary', priority: 1 },
  ...
  'omics-differential-exploration': {
    ...
    componentPolicy: {
      ...
      allowedComponents: ['volcano-plot', 'heatmap-viewer', 'umap-viewer', 'point-set-viewer', 'matrix-viewer', 'data-table', 'record-table', 'evidence-matrix', 'execution-unit-table', 'unknown-artifact-inspector'],
      fallbackComponent: 'unknown-artifact-inspector',
      dynamicPlugins: 'disabled-by-default',
    },
  ...
  'biomedical-knowledge-graph': {
    ...
    componentPolicy: {
      ...
      allowedComponents: ['network-graph', 'graph-viewer', 'data-table', 'record-table', 'evidence-matrix', 'paper-card-list', 'execution-unit-table', 'unknown-artifact-inspector'],
      fallbackComponent: 'unknown-artifact-inspector',
      dynamicPlugins: 'disabled-by-default',
    },
