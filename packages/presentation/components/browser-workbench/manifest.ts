...
export const manifest: UIComponentManifest = {
  ...
  description: 'Presentation-only right-pane browser session, tab, snapshot, and terminal-equivalent command surface for browser_runtime projections.',
  ...
  viewParams: ['session', 'activeTab', 'snapshot', 'traceRefs', 'commands', 'previewUrl'],
  interactionEvents: [
  ...
  docs: {
    ...
    agentSummary: 'Use for displaying an existing browser_runtime projection in the right pane. It emits terminal-equivalent browser command events; TUI/runtime owns provider routing, page actions, snapshots, logs, downloads, and approvals.',
  },
  workbenchDemo: {
