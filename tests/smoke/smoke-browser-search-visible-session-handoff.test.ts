    ...
    sourcePages: [
      {
        ...
        title: 'Refs-first browser evidence',
        url: 'https://example.org/browser/refs-first',
        finalUrl: 'https://example.org/browser/refs-first',
        openedAt: '2026-06-01T00:00:02.000Z',
        status: 'read',
        textRef: `browser-host-session:${VISIBLE_SESSION_ID}/source-pages/source-1-refsfirst.txt`,
        textPreview: 'Opened source page text confirms BrowserHostSession keeps search evidence refs-first and summarizes only after reading source-page content.',
        textCharCount: 132,
        textSha1: 'refsfirstsource',
      },
      {
        resultIndex: 1,
        title: 'Visible BrowserHostSession reuse',
        url: 'https://example.org/browser/session-reuse',
        finalUrl: 'https://example.org/browser/session-reuse',
        openedAt: '2026-06-01T00:00:03.000Z',
        status: 'read',
        textRef: `browser-host-session:${VISIBLE_SESSION_ID}/source-pages/source-2-sessionreuse.txt`,
        textPreview: 'Opened source page text confirms the visible host-owned browser session remains the single interactive owner after browser_search.',
        textCharCount: 118,
        textSha1: 'sessionreusesource',
      },
    ],
