...
import { domainPackageDefinition as domainPackageDefinition8 } from '@sciforge/domain-content-space-mock-provider/definition'
import { domainPackageDefinition as domainPackageDefinition9 } from '@sciforge/domain-create-loop/definition'
import { domainPackageDefinition as domainPackageDefinition10 } from '@sciforge/domain-dataset-api/definition'
import { domainPackageDefinition as domainPackageDefinition11 } from '@sciforge/domain-evidence-dag/definition'
import { domainPackageDefinition as domainPackageDefinition12 } from '@sciforge/domain-git-checkpoints/definition'
import { domainPackageDefinition as domainPackageDefinition13 } from '@sciforge/domain-identity-access/definition'
import { domainPackageDefinition as domainPackageDefinition14 } from '@sciforge/domain-life-science-preview/definition'
import { domainPackageDefinition as domainPackageDefinition15 } from '@sciforge/domain-opencontent-connector/definition'
import { domainPackageDefinition as domainPackageDefinition16 } from '@sciforge/domain-opencontent-content-space-provider/definition'
import { domainPackageDefinition as domainPackageDefinition17 } from '@sciforge/domain-paper-radar/definition'
