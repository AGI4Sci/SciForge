...
export function rewriteGenericPlannerAction(action: GenericVisionAction, config: VisionSenseConfig, steps: LoopStep[], task: string): GenericVisionAction {
...
export function shouldTolerateDenseUiNoEffectAction(task: string, steps: LoopStep[], action: GenericVisionAction) {
...
export function shouldCompleteFromCreationActionLedger(task: string, steps: LoopStep[]) {
...
export function visibleArtifactCompletionGap(task: string, steps: LoopStep[]) {
...
export function shouldCompleteFromFileManagerActionLedger(task: string, steps: LoopStep[]) {
...
export function shouldCompleteFromSettingsFormActionLedger(task: string, steps: LoopStep[]) {
...
export function shouldCompleteFromValidationRecoveryActionLedger(task: string, steps: LoopStep[]) {
...
export function shouldCompleteFromExpectedFailureActionLedger(task: string, steps: LoopStep[]) {
...
export function shouldCompleteFromWindowRecoveryActionLedger(task: string, steps: LoopStep[]) {
