...
- Put reusable schema, artifact, object reference, verifier, or UI manifest contracts in `packages/contracts/runtime`, `packages/scenarios/core`, or the owning package public export.
