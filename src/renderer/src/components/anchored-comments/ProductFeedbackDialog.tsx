...
const OPTIONS: Array<{
...
}> = [
  {
    ...
    description: 'Full SciForge window with the target circled, plus a focused crop.',
    safe: true
  },
  {
  ...
  },
  {
    key: 'logs',
    title: 'Recent logs',
    description: 'Diagnostic logs may include command output or local details.',
    safe: false
  },
  {
    key: 'conversationExcerpt',
    title: 'Conversation excerpt',
    description: 'Relevant messages from the active AI conversation.',
    safe: false
  },
  {
    key: 'workspacePaths',
