...
export const ANCHORED_COMMENTS_ADD_TO_CONVERSATION_EVENT =
  'sciforge:anchored-comments-add-to-conversation' as const
...
export type AnchoredCommentsAddToConversationDetail = {
  threadIds: string[]
}
...
export const useAnchoredCommentStore = create<AnchoredCommentStoreState>((set, get) => ({
  ...
  addSelectedToConversation: () => {
    ...
    dispatchWindowEvent<AnchoredCommentsAddToConversationDetail>(
