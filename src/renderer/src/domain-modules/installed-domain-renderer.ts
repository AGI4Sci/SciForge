...
import { createDomainRendererEntry as createDomainRendererEntry12 } from '@sciforge/domain-research-checkpoints/renderer'
import { createDomainRendererEntry as createDomainRendererEntry13 } from '@sciforge/domain-research-dossier/renderer'
import { createDomainRendererEntry as createDomainRendererEntry14 } from '@sciforge/domain-scientific-plotting/renderer'
import { createDomainRendererEntry as createDomainRendererEntry15 } from '@sciforge/domain-terminal/renderer'
import { createDomainRendererEntry as createDomainRendererEntry16 } from '@sciforge/domain-visual-review/renderer'
