...
import { extractLatencyPolicy, extractResponsePlan } from '../../latencyPolicy';
import { SCENARIO_SPECS } from '@sciforge/scenario-core/scenario-specs';
import { skillDomainForRuntimeInput } from '@sciforge/scenario-core/scenario-routing-policy';
...
export function compactTransportExecutionUnits(units: NonNullable<SendAgentMessageInput['executionUnits']>) {
...
export function compactSciForgeReference(reference: NonNullable<SendAgentMessageInput['references']>[number]) {
