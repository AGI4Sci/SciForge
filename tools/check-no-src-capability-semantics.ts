...
const trackedBaselineCounts: Record<string, number> = {
  ...
  'src/runtime/gateway/context-envelope.ts#artifact-id-hardcode': 1,
  ...
  'src/runtime/gateway/generated-task-runner.ts#artifact-id-hardcode': 6,
  'src/runtime/gateway/generated-task-runner.ts#component-id-hardcode': 0,
  'src/runtime/gateway/generated-task-runner.ts#domain-prompt-regex': 1,
  ...
  'src/ui/src/api/agentClient/responseNormalization.ts#artifact-id-hardcode': 2,
  ...
  'src/ui/src/api/agentClient/responseNormalization.ts#domain-prompt-regex': 1,
