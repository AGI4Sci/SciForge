...
const trackedBaselineCounts: Record<string, number> = {
  ...
  'src/runtime/gateway/direct-answer-payload.ts#artifact-id-hardcode': 6,
  ...
  'src/runtime/vision-sense/computer-use-plan.ts#domain-prompt-regex': 3,
  ...
  'src/ui/src/app/results/viewPlanResolver.ts#artifact-id-hardcode': 9,
  'src/ui/src/app/results/viewPlanResolver.ts#component-id-hardcode': 8,
