...
const trackedBaselineCounts: Record<string, number> = {
  ...
  'src/runtime/gateway/agentserver-prompts.ts#domain-default-routing': 1,
  'src/runtime/gateway/agentserver-prompts.ts#domain-prompt-regex': 5,
  'src/runtime/gateway/agentserver-prompts.ts#scenario-provider-id-hardcode': 1,
  ...
  'src/runtime/gateway/generated-task-runner.ts#domain-prompt-regex': 3,
  ...
  'src/runtime/vision-sense/computer-use-plan.ts#domain-prompt-regex': 1,
  ...
  'src/ui/src/app/chat/runOrchestrator.ts#artifact-id-hardcode': 6,
  'src/ui/src/app/chat/runOrchestrator.ts#component-id-hardcode': 0,
  'src/ui/src/app/chat/runOrchestrator.ts#domain-prompt-regex': 2,
  ...
  'src/ui/src/app/results/viewPlanResolver.ts#artifact-id-hardcode': 4,
  'src/ui/src/app/results/viewPlanResolver.ts#component-id-hardcode': 5,
