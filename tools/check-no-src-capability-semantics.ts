...
const trackedBaselineCounts: Record<string, number> = {
  ...
  'src/runtime/gateway/backend-context-window.ts#artifact-id-hardcode': 0,
  'src/runtime/gateway/backend-prompt-policy.ts#artifact-id-hardcode': 0,
  'src/runtime/gateway/backend-prompt-policy.ts#component-id-hardcode': 0,
  'src/runtime/gateway/backend-prompt-policy.ts#domain-default-routing': 0,
  'src/runtime/gateway/backend-prompt-policy.ts#domain-prompt-regex': 0,
  'src/runtime/gateway/backend-prompt-policy.ts#scenario-provider-id-hardcode': 0,
  'src/runtime/gateway/artifact-materializer.ts#artifact-id-hardcode': 0,
  'src/runtime/gateway/artifact-materializer.ts#domain-default-routing': 0,
  'src/runtime/gateway/artifact-materializer.ts#domain-prompt-regex': 0,
  'src/runtime/gateway/backend-failure-diagnostics.ts#artifact-id-hardcode': 0,
  'src/runtime/gateway/backend-failure-diagnostics.ts#domain-prompt-regex': 0,
  'src/runtime/gateway/context-envelope.ts#artifact-id-hardcode': 0,
  ...
  'src/runtime/gateway/direct-context-fast-path.ts#domain-prompt-regex': 0,
  'src/runtime/gateway/direct-context-fast-path.ts#scenario-provider-id-hardcode': 0,
  'src/runtime/gateway/generated-task-runner.ts#artifact-id-hardcode': 0,
  ...
  'src/runtime/gateway/repair-policy.ts#domain-prompt-regex': 0,
  'src/runtime/gateway/repair-policy.ts#scenario-provider-id-hardcode': 0,
  'src/runtime/gateway/runtime-routing.ts#artifact-id-hardcode': 0,
  ...
  'src/runtime/task-project-contracts.ts#artifact-id-hardcode': 0,
  ...
  'src/runtime/vision-sense/computer-use-trace-output.ts#component-id-hardcode': 0,
  'src/runtime/vision-sense/sense-provider.ts#domain-prompt-regex': 0,
  'src/runtime/workspace-server.ts#artifact-id-hardcode': 0,
  'src/runtime/workspace-task-input.ts#artifact-id-hardcode': 0,
  'src/runtime/workspace-task-input.ts#domain-prompt-regex': 0,
  'src/runtime/workspace-task-runner.ts#domain-default-routing': 0,
  'src/ui/src/api/agentClient/responseNormalization.ts#artifact-id-hardcode': 0,
  ...
  'src/ui/src/api/scopeCheck.ts#domain-default-routing': 0,
  'src/ui/src/api/scopeCheck.ts#domain-prompt-regex': 0,
  'src/ui/src/app/AlignmentPages.tsx#component-id-hardcode': 0,
  ...
  'src/ui/src/app/ComponentWorkbenchPage.tsx#component-id-hardcode': 0,
  ...
  'src/ui/src/app/appShell/ShellPanels.tsx#artifact-id-hardcode': 0,
  'src/ui/src/app/appShell/ShellPanels.tsx#scenario-provider-id-hardcode': 0,
  'src/ui/src/app/appShell/explorerModels.ts#artifact-id-hardcode': 0,
  ...
  'src/ui/src/app/chat/sessionTransforms.ts#scenario-provider-id-hardcode': 0,
  'src/ui/src/app/results/ArtifactCardControls.tsx#artifact-id-hardcode': 0,
  'src/ui/src/app/results/ExecutionNotebookPanels.tsx#artifact-id-hardcode': 0,
  ...
  'src/ui/src/app/results/WorkspaceObjectPreview.tsx#artifact-id-hardcode': 0,
  ...
  'src/ui/src/app/results/reportContent.tsx#artifact-id-hardcode': 0,
  'src/ui/src/app/results/reportContent.tsx#component-id-hardcode': 0,
  'src/ui/src/app/results/reportContent.tsx#domain-default-routing': 0,
  'src/ui/src/app/results/reportContent.tsx#domain-prompt-regex': 0,
  'src/ui/src/app/results/resultArtifactHelpers.ts#artifact-id-hardcode': 0,
  ...
  'src/ui/src/app/uiPrimitives.tsx#artifact-id-hardcode': 0,
  'src/ui/src/app/uiPrimitives.tsx#component-id-hardcode': 0,
  'src/ui/src/app/uiPrimitives.tsx#scenario-provider-id-hardcode': 0,
  ...
  'src/ui/src/domain.ts#artifact-id-hardcode': 0,
  'src/ui/src/domain.ts#domain-default-routing': 0,
  'src/ui/src/feedback/FeedbackCaptureLayer.tsx#artifact-id-hardcode': 0,
  'src/ui/src/processProgress.ts#artifact-id-hardcode': 0,
  'src/ui/src/processProgress.ts#domain-prompt-regex': 0,
  'src/ui/src/runtimeContracts.ts#artifact-id-hardcode': 0,
  'src/ui/src/runtimeContracts.ts#domain-default-routing': 0,
  'src/ui/src/runtimeHealth.ts#artifact-id-hardcode': 0,
  'src/ui/src/sessionStore.ts#artifact-id-hardcode': 0,
  'src/ui/src/streamEventPresentation.ts#artifact-id-hardcode': 0,
  'src/ui/src/streamEventPresentation.ts#domain-prompt-regex': 0,
  'src/ui/src/visualizations.tsx#artifact-id-hardcode': 0,
  'src/ui/src/visualizations.tsx#component-id-hardcode': 0,
  'src/ui/src/visualizations.tsx#domain-default-routing': 0,
  'src/ui/src/workEventAtoms.ts#artifact-id-hardcode': 0,
  'src/ui/src/workEventAtoms.ts#domain-prompt-regex': 0,
};
