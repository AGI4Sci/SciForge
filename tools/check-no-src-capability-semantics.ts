...
const trackedBaselineCounts: Record<string, number> = {
  ...
  'src/ui/src/app/results/viewPlanResolver.ts#artifact-id-hardcode': 28,
  'src/ui/src/app/results/viewPlanResolver.ts#component-id-hardcode': 62,
  'src/ui/src/app/results/viewPlanResolver.ts#domain-default-routing': 7,
  'src/ui/src/app/results/viewPlanResolver.ts#domain-prompt-regex': 9,
