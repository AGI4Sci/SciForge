...
const trackedBaselineCounts: Record<string, number> = {
  ...
  'src/runtime/gateway/artifact-reference-context.ts#provider-scenario-prompt-special-case': 2,
  ...
  'src/runtime/gateway/capability-evolution-events.ts#provider-scenario-prompt-special-case': 2,
  'src/runtime/gateway/repair-policy.ts#provider-scenario-prompt-special-case': 3,
  'src/runtime/gateway/work-evidence-guard.ts#provider-scenario-prompt-special-case': 4,
  ...
  'src/ui/src/scenarioCompiler/componentElements.ts#legacy-package-facade-reexport': 1,
  'src/ui/src/scenarioCompiler/elementRegistry.ts#legacy-package-facade-reexport': 1,
  'src/ui/src/scenarioCompiler/elementTypes.ts#legacy-package-facade-reexport': 1,
  'src/ui/src/scenarioCompiler/runtimeSmoke.ts#legacy-package-facade-reexport': 1,
  'src/ui/src/scenarioCompiler/scenarioDraftCompiler.ts#legacy-package-facade-reexport': 1,
  'src/ui/src/scenarioCompiler/scenarioElementCompiler.ts#legacy-package-facade-reexport': 1,
  'src/ui/src/scenarioCompiler/scenarioLibrary.ts#legacy-package-facade-reexport': 1,
  'src/ui/src/scenarioCompiler/scenarioPackage.ts#legacy-package-facade-reexport': 1,
  'src/ui/src/scenarioCompiler/scenarioQualityGate.ts#legacy-package-facade-reexport': 1,
  'src/ui/src/scenarioCompiler/skillPlanCompiler.ts#legacy-package-facade-reexport': 1,
  'src/ui/src/scenarioCompiler/uiPlanCompiler.ts#legacy-package-facade-reexport': 1,
  'src/ui/src/scenarioCompiler/validationGate.ts#legacy-package-facade-reexport': 1,
