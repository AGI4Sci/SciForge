...
const alwaysUnsafePublicEventPayloadLiteral = /(?:\b(?:rawScreenshotPath|rawScreenshotBase64|screenshotBase64|providerPayload|rawProviderPayload|rawVisibleText|visibleText|rawSelectedText|selectedText|rawSelection|selectedRange|insertText|replacementText|rawDraftText|draftText|draftBody|rawDiff|diff|patch|previewBody|artifactData|rawCommand|rawPath|rawUrl|requestedUrl|currentUrl|finalUrl|url|href)\b\s*:|data:image\/|;base64,)/i;
