...
- archive/historical: 2026-05-14/15 的 PROJECT 历史长段已归档到 [`archive/PROJECT-history-2026-05-14-15.md`](archive/PROJECT-history-2026-05-14-15.md)。其中 CAP/PSM/MEM/H022 未完成项只能作为 evidence/source lineage，当前实现入口只认根目录 `PROJECT.md` 的 SA-* 任务板。
- archive/historical: 2026-05-17 的 UX simplification / capability discovery / P1-P6 strict-eval 长任务板已归档到 [`archive/PROJECT-history-2026-05-17-ux-gauntlet.md`](archive/PROJECT-history-2026-05-17-ux-gauntlet.md)。当前 owner、状态、handoff 和未关闭 blocker 以根目录 [`../PROJECT.md`](../PROJECT.md) 为准。
