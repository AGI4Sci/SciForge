...
- [ ] 第二阶段打开 feature flag，让 context envelope、broker、prompt renderer、verification policy、repair loop、UI progress 逐项消费 contract。（context envelope、verification policy、progress plan、continuity/backend selection 与 prompt renderer metadata 已有 opt-in/首片；broker、repair loop 和默认启用仍待推进。）
