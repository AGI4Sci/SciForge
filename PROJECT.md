...
状态：complete for p3 gui-present path / p4 compat guard landed / strict live gate blocked without credential
...
状态：p3 gui-present live passed / p4 strict manifest fail-closed without credential
